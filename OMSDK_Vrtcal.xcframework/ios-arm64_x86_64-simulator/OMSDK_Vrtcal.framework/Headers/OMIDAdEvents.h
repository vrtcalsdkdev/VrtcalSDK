 ...
 */
@interface OMIDVrtcalAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDVrtcalAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDVrtcalVASTProperties *_Nonnull)vastProperties
