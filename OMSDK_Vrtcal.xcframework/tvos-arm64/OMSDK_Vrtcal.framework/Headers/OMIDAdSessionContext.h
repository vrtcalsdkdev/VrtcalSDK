 ...
 */
@interface OMIDVrtcalAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDVrtcalPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDVrtcalPartner *)partner
                               ...
                               resources:(NSArray<OMIDVrtcalVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
