 ...
 */
@interface OMIDVrtcalAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDVrtcalAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDVrtcalAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDVrtcalAdSessionContext *)context
