...
(function() {
    ...
    var callContainer = function(command) {
        debugVRTMraid("callContainer: command = [" + command + "]");
        ...
        debugVRTMraid("callContainer: window.open url = [" + openURL + "]");
    ...
    */
    ...
    mraid.expand = function(url) {
        debugVRTMraid("mraid.expand url=[" + url + "]");
        if (url) {
    ...
    mraid.getPlacementType = function() {
        var ret = mraid.placementType;
        debugVRTMraid("mraid.getPlacementType: " + ret);
        return ret;
    };
    ...
    mraid.getState = function() {
        debugVRTMraid("mraid.getState: " + mraid.state);
        return mraid.state;
    };

    /* The MRAID specification that this SDK is certified against. */
    mraid.getVersion = function() {
        debugVRTMraid("mraid.getVersion: 3.0");
        return '3.0';
    };
    ...
    mraid.isViewable = function() {
        debugVRTMraid("mraid.viewable: " + mraid.viewable);
    ...
    mraid.getScreenSize = function() {
        debugVRTMraid("mraid.getScreenSize: " + JSON.stringify(mraid.screenSize));
        return mraid.screenSize;
    };
 
    mraid.setScreenSize = function(w, h) {
        debugVRTMraid("mraid.setScreenSize: w=" + w + ", h=" + h);
    ...
    mraid.getMaxSize = function() {
        debugVRTMraid("mraid.getMaxSize: " + JSON.stringify(mraid.maxSize));
        return mraid.maxSize;
    };

    mraid.setMaxSize = function(w, h) {
        debugVRTMraid("mraid.setMaxSize: w=" + w + ", h=" + h);
    ...
    mraid.setOrientationProperties = function(properties) {
        debugVRTMraid("mraid.setOrientationProperties: " + JSON.stringify(properties));
        if (!properties)
            return;
    ...
    mraid.getResizeProperties = function() {
        debugVRTMraid("mraid.getResizeProperties: " + JSON.stringify(mraid.resizeProperties));
    ...
    mraid.setResizeProperties = function(properties) {
        ...
        debugVRTMraid("mraid.setResizeProperties: " + JSON.stringify(properties));
    ...
    mraid.onSizeChange = function(width, height) {
        debugVRTMraid("mraid.onSizeChange(" + width + "," + height + ")");
    ...
    mraid.onViewableChange = function(isViewable) {
        debugVRTMraid("mraid.onViewableChange(" + isViewable + ")");
...
debugVRTMraid("Finished adding mraid.js");
